package simplecalculatorusingjavaawt;

import java.awt.*;  
import java.awt.event.*;  
class AWTCalculator extends WindowAdapter implements ActionListener{ 
  Frame f; 
Label l1;
...
StringIndexOutOfBoundsException f){return;}
  l1.setText(z);
}
                //AIRTHMETIC BUTTON
...
//MAIN METHOD where objects of AWTCalculator is instantaiated
